...
<v-card-text>
1. Настоящая Политика по работе с персональными данными субъектов в ООО «Копикс-принт» (далее – Оператор/Компания).
 </v-card-text>
 <v-card-text>
2. Политика обработки персональных данных (далее – Политика) составлена в соответствии с законодательством Республики Беларусь и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, Пользователей сайта 7712.by.
 </v-card-text>
<v-card-text>
...
<v-card-text>
4. Веб-сайт – совокупность графических и информационных материалов, текстов, дизайна, видеоматериалов и иных результатов интеллектуальной деятельности Оператора, а также программ для ЭВМ, обеспечивающих их доступность в сети Интернет по сетевому адресу 7712.by.
</v-card-text>
<v-card-text>
...
<v-card-text>
9. Пользователь/Субъект персональных данных – любой посетитель веб-сайта 7712.by.
</v-card-text>
<v-card-text>
...
<v-card-text>
– предоставления доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте 7712.by ;
</v-card-text>
<v-card-text>
...
<v-card-text>
Пользователь всегда может отказаться от получения информационных рассылок и рекламных материалов, перейдя по ссылке в информационном письме info@7712.by и кликнув по тексту «не получать наши новости, нажмите здесь».
</v-card-text>
<v-card-subtitle>
...
<v-card-text>
29. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <NuxtLink to="/policy"><b > Политика в отношении обработки персональных данных — 7712.by</b></NuxtLink>
</v-card-text>
<v-card-text>
